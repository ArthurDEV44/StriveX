...
export const translations = {
  fr: {
    ...
    'pricing.scale.description': 'Pour startups seed, SaaS en lancement ou déjà en place',
  ...
  en: {
    ...
    'pricing.scale.description': 'For seed startups, launching SaaS or already in place',
